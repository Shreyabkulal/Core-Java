class CarVacuumCleaner{
   ...
   public static void main(String[] vacuumCleaner){
	...
	String brand="WOSCHER";
    String specialFeature="HEPA,Bag,Portable,Deep Cleaning,Washable Filter,Detachable,Easy Storage with Storage Bag,Wet/Dry,LightweightHEPA,Bag,Portable,Deep Cleaning,Washable Filter,Detachable,Easy Storage with Storage Bag,Wet/Dry,Lightweight";
    String filterType="HEPA Filter";
    String includedComponents="1 Washable HEPA filter, 3 nozzle Attachments, 1 Exra Fuse, 1 Woscher Car Perfume, 1 HEPA Filter Cleaning Brush and 1 Woscher Carrying case.1 Washable HEPA filter, 3 nozzle Attachments, 1 Exra Fuse, 1 Woscher Car Perfume, 1 HEPA Filter Cleaning Brush and 1 Woscher Carrying case.";
